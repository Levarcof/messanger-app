    ...
    return ( 
        <div>
           ...
           <div className="mt-2">
            ...
            className={clsx(`form-input block w-full rounded-md border-0 px-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:inset focus:ring-sky-600 sm"text-sm sm:leading-6 ` 
